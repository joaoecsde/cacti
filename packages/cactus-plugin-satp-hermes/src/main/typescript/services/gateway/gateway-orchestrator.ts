...
export class GatewayOrchestrator {
  ...
  */
  ...
  // Async discovery and channel creation  
  ...
  // Create a channel from a discovered gateway
  ...
  // Establish connection to a discovered gateway
  ...
  // Get Kademlia discovery statistics
